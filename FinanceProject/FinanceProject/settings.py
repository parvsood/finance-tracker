...
SECRET_KEY = 'django-insecure-o8phys3-5vu*g+++(jf_@j#ygkj_92!r!ycy^e)kn6$fnvv#45'
...
DATABASE_ROUTERS = []
DATABASE_CONNECTION_POOLING = False  # SQLite doesn't support connection pooling

# Configure connection age
